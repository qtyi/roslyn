...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.ReferenceHighlighting
{
    ...
    {
        [Fact]
        public Task TestValueTupleUsingAlias1()
            => TestAsync(
                """
        ...
        [Fact]
        public Task TestValueTupleUsingAlias2()
            => TestAsync(
                """
                using X = System.{|Cursor:[|ValueTuple|]|}<object, object>;
        ...
        [Fact]
        public Task TestTupleUsingAlias1()
            => TestAsync(
                """
        ...
        [Fact]
        public Task TestTupleUsingAlias2()
            => TestAsync(
                """
                using {|Cursor:X|} = [|(object, object)|];
        ...
        [Fact]
        public Task TestValueTupleUsingAliasWithGlobalUsings1()
        ...
        [Fact]
        public Task TestTupleUsingAliasWithGlobalUsings1()
            => TestWithGlobalUsingsAsync(
                markup:
                """
                using {|Cursor:Y|} = [|(object, object)|];
