...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.ReferenceHighlighting
{
    ...
    {
        protected sealed override EditorTestWorkspace CreateWorkspace([StringSyntax(PredefinedEmbeddedLanguageNames.CSharpTest)] string markup, ParseOptions options)
        ...
        internal async Task TestWithGlobalUsingsAsync([StringSyntax(PredefinedEmbeddedLanguageNames.CSharpTest)] string markup, [StringSyntax(PredefinedEmbeddedLanguageNames.CSharpTest)] string globalUsings,
