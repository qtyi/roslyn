...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.ReferenceHighlighting
{
    ...
    {
        protected sealed override TestWorkspace CreateWorkspace(string markup, ParseOptions options)
            ...
            IEnumerable<IReferenceFinder>? additionalReferenceFinders = null)
        {
            ...
            {
                await TestAsync(TestWorkspace.CreateCSharp(new[] { markup }, new[] { globalUsings }, options), testOptions);
            }
        }
    }
}
