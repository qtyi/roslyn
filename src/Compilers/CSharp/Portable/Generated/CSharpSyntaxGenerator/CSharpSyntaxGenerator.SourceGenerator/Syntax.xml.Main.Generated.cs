...
#pragma warning restore RS0027
        ...
        public static UsingDirectiveSyntax UsingDirective(SyntaxToken globalKeyword, SyntaxToken usingKeyword, SyntaxToken staticKeyword, SyntaxToken unsafeKeyword, SyntaxToken identifier, TypeParameterListSyntax? typeParameterList, SyntaxToken equalsToken, TypeSyntax namespaceOrType, SyntaxToken semicolonToken)
        {
        ...
        /// <summary>Creates a new UsingDirectiveSyntax instance.</summary>
        public static UsingDirectiveSyntax UsingDirective(SyntaxToken identifier, TypeParameterListSyntax? typeParameterList, TypeSyntax namespaceOrType)
            => SyntaxFactory.UsingDirective(default, SyntaxFactory.Token(SyntaxKind.UsingKeyword), default, default, identifier, typeParameterList, default, namespaceOrType, SyntaxFactory.Token(SyntaxKind.SemicolonToken));

        /// <summary>Creates a new UsingDirectiveSyntax instance.</summary>
        public static UsingDirectiveSyntax UsingDirective(TypeSyntax namespaceOrType)
            => SyntaxFactory.UsingDirective(default, SyntaxFactory.Token(SyntaxKind.UsingKeyword), default, default, default, default, default, namespaceOrType, SyntaxFactory.Token(SyntaxKind.SemicolonToken));
