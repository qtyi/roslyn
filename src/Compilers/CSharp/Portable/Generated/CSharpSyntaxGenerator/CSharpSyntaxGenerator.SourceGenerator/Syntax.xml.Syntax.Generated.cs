...
public sealed partial class UsingDirectiveSyntax : CSharpSyntaxNode
{
    ...
    public SyntaxList<TypeParameterConstraintClauseSyntax> ConstraintClauses => new SyntaxList<TypeParameterConstraintClauseSyntax>(GetRed(ref this.constraintClauses, 8));

    public SyntaxToken SemicolonToken => new SyntaxToken(this, ((InternalSyntax.UsingDirectiveSyntax)this.Green).semicolonToken, GetChildPosition(9), GetChildIndex(9));
    ...
    public UsingDirectiveSyntax Update(SyntaxToken globalKeyword, SyntaxToken usingKeyword, SyntaxToken staticKeyword, SyntaxToken unsafeKeyword, SyntaxToken identifier, TypeParameterListSyntax? typeParameterList, SyntaxToken equalsToken, TypeSyntax namespaceOrType, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken semicolonToken)
    {
        if (globalKeyword != this.GlobalKeyword || usingKeyword != this.UsingKeyword || staticKeyword != this.StaticKeyword || unsafeKeyword != this.UnsafeKeyword || identifier != this.Identifier || typeParameterList != this.TypeParameterList || equalsToken != this.EqualsToken || namespaceOrType != this.NamespaceOrType || constraintClauses != this.ConstraintClauses || semicolonToken != this.SemicolonToken)
        {
            var newNode = SyntaxFactory.UsingDirective(globalKeyword, usingKeyword, staticKeyword, unsafeKeyword, identifier, typeParameterList, equalsToken, namespaceOrType, constraintClauses, semicolonToken);
            var annotations = GetAnnotations();
            return annotations?.Length > 0 ? newNode.WithAnnotations(annotations) : newNode;
        }
    ...
    public UsingDirectiveSyntax WithGlobalKeyword(SyntaxToken globalKeyword) => Update(globalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithUsingKeyword(SyntaxToken usingKeyword) => Update(this.GlobalKeyword, usingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithStaticKeyword(SyntaxToken staticKeyword) => Update(this.GlobalKeyword, this.UsingKeyword, staticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithUnsafeKeyword(SyntaxToken unsafeKeyword) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, unsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithIdentifier(SyntaxToken identifier) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithTypeParameterList(TypeParameterListSyntax? typeParameterList) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, typeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithEqualsToken(SyntaxToken equalsToken) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, equalsToken, this.NamespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithNamespaceOrType(TypeSyntax namespaceOrType) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, namespaceOrType, this.ConstraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithConstraintClauses(SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, constraintClauses, this.SemicolonToken);
    public UsingDirectiveSyntax WithSemicolonToken(SyntaxToken semicolonToken) => Update(this.GlobalKeyword, this.UsingKeyword, this.StaticKeyword, this.UnsafeKeyword, this.Identifier, this.TypeParameterList, this.EqualsToken, this.NamespaceOrType, this.ConstraintClauses, semicolonToken);
    ...
    public UsingDirectiveSyntax AddConstraintClauses(params TypeParameterConstraintClauseSyntax[] items) => WithConstraintClauses(this.ConstraintClauses.AddRange(items));
}
