...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal sealed partial class AliasSymbolFromSyntax : AliasSymbol
    {
        ...
        public override string MetadataName
        {
            ...
            {
                return Arity == 0 ? Name :
                    MetadataHelpers.ComposeAritySuffixedMetadataName(Name, Arity, associatedFileIdentifier: null);
            }
        }
        ...
        {
            TypeMap map = new TypeMap(TypeParameters, typeArguments);
            return map.SubstituteType(Target as TypeSymbol).Type;
        }
    }
}
