    ...
    internal abstract class SourceDelegateMethodSymbol : SourceMemberMethodSymbol
    {
        ...
        private sealed class Constructor : SourceDelegateMethodSymbol
        {
            internal Constructor(
                ...
                DelegateDeclarationSyntax syntax)
                : base(delegateType, voidType, voidType, syntax, MethodKind.Constructor, RefKind.None, DeclarationModifiers.Public)
            {
        ...
        private sealed class InvokeMethod : SourceDelegateMethodSymbol
        {
            ...
            internal InvokeMethod(
                ...
                Binder binder,
                BindingDiagnosticBag diagnostics)
                : base(delegateType, returnType, returnTypeWithoutUnwrappingAliasTarget, syntax, MethodKind.DelegateInvoke, refKind, DeclarationModifiers.Virtual | DeclarationModifiers.Public)
            {
        ...
        private sealed class BeginInvokeMethod : SourceDelegateMethodSymbol
        {
            internal BeginInvokeMethod(
                ...
                DelegateDeclarationSyntax syntax)
                : base((SourceNamedTypeSymbol)invoke.ContainingType, iAsyncResultType, iAsyncResultType, syntax, MethodKind.Ordinary, RefKind.None, DeclarationModifiers.Virtual | DeclarationModifiers.Public)
            {
        ...
        private sealed class EndInvokeMethod : SourceDelegateMethodSymbol
        {
            ...
            internal EndInvokeMethod(
                ...
                TypeWithAnnotations iAsyncResultType,
                DelegateDeclarationSyntax syntax)
                : base((SourceNamedTypeSymbol)invoke.ContainingType, invoke.ReturnTypeWithAnnotations, invoke.GetReturnTypeWithoutUnwrappingAliasTarget(), syntax, MethodKind.Ordinary, invoke.RefKind, DeclarationModifiers.Virtual | DeclarationModifiers.Public)
            {
                _invoke = invoke;
