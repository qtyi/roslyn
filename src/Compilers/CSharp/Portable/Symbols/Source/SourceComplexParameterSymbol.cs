...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceComplexParameterSymbolBase : SourceParameterSymbol, IAttributeTargetSymbol
    {
        ...
        protected SourceComplexParameterSymbolBase(
            ...
            ScopedKind scope)
            : base(owner, parameterType, parameterTypeWithoutUnwrappingAliasTarget, ordinal, refKind, scope, name, location)
        {
...
#nullable disable
    ...
    internal sealed class SourceComplexParameterSymbol : SourceComplexParameterSymbolBase
    {
        internal SourceComplexParameterSymbol(
            ...
            bool isExtensionMethodThis,
            ScopedKind scope)
            : base(owner, ordinal, parameterType, parameterTypeWithoutUnwrappingAliasTarget, refKind, name, location, syntaxRef, isParams, isExtensionMethodThis, scope)
        {
        }
