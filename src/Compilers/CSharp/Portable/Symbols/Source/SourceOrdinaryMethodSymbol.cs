    ...
    internal abstract class SourceOrdinaryMethodSymbol : SourceOrdinaryMethodSymbolBase
    {
            ...
            BindingDiagnosticBag diagnostics)
        {
            ...
            return explicitInterfaceType is null && !syntax.Modifiers.Any(SyntaxKind.PartialKeyword) && syntax.Arity == 0
                ...
                : new SourceOrdinaryMethodSymbolComplex(containingType, explicitInterfaceType, explicitInterfaceTypeWithoutUnwrappingAliasTarget, name, location, syntax, methodKind, isNullableAnalysisEnabled, diagnostics);
        }
        ...
        private (TypeWithAnnotations ReturnType, TypeWithAnnotations ReturnTypeWithoutUnwrappingAliasTarget, ImmutableArray<ParameterSymbol> Parameters, ImmutableArray<TypeParameterConstraintClause> DeclaredConstraintsForOverrideOrImplementation) MakeParametersAndBindReturnType(BindingDiagnosticBag diagnostics)
        {
            ...
            return (returnType, returnTypeWithoutUnwrappingAliasTarget, parameters, declaredConstraints);
...
#nullable enable
        protected override void MethodChecks(BindingDiagnosticBag diagnostics)
        {
            ...
            var (returnType, returnTypeWithoutUnwrappingAliasTarget, parameters, declaredConstraints) = MakeParametersAndBindReturnType(diagnostics);

            MethodSymbol? overriddenOrExplicitlyImplementedMethod = MethodChecks(returnType, returnTypeWithoutUnwrappingAliasTarget, parameters, diagnostics);
...
#nullable disable
        ...
        private sealed class SourceOrdinaryMethodSymbolComplex : SourceOrdinaryMethodSymbol
        {
            ...
            {
                if (_typeParameterInfo.LazyTypeParameterConstraintTypesWithoutUnwrappingAliasTarget.IsDefault)
                {
                    GetTypeParameterConstraintKinds();
                    ...
                    ImmutableInterlocked.InterlockedInitialize(
                            ref _typeParameterInfo.LazyTypeParameterConstraintTypesWithoutUnwrappingAliasTarget,
                            constraints);
                }

                return _typeParameterInfo.LazyTypeParameterConstraintTypesWithoutUnwrappingAliasTarget;
            }
