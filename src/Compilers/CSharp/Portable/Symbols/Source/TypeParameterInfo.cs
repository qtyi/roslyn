...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class TypeParameterInfo
    {
        ...
        public ImmutableArray<ImmutableArray<TypeWithAnnotations>> LazyTypeParameterConstraintTypesWithoutUnwrappingAliasTarget;
        ...
        public static readonly TypeParameterInfo Empty = new TypeParameterInfo
        {
            ...
            LazyTypeParameterConstraintTypesWithoutUnwrappingAliasTarget = ImmutableArray<ImmutableArray<TypeWithAnnotations>>.Empty,
