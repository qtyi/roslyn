...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal readonly struct NamedTypeOrAliasSymbol
    {
        ...
        private NamedTypeOrAliasSymbol(NamedTypeSymbol namedTypeSymbol) => NamedTypeSymbol = namedTypeSymbol;

        private NamedTypeOrAliasSymbol(AliasSymbolFromSyntax aliasSymbol) => AliasSymbol = aliasSymbol;
