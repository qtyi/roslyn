                ...
                if (result.IsMultiViable)
                {
                    ...
                    else
                    {
                        ...
                        if ((object)singleType != null && singleType.PrimitiveTypeCode == Cci.PrimitiveTypeCode.Void && simpleName == "Void")
                        {
                            ...
                            singleResult = new ExtendedErrorTypeSymbol(GetContainingNamespaceOrNonExtensionType(singleType), singleType, LookupResultKind.NotReferencable, errorInfo); // UNDONE: Review resultkind.
                        }
