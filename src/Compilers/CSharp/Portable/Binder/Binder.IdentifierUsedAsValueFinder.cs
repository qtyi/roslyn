...
namespace Microsoft.CodeAnalysis.CSharp
{
    partial class Binder
    {
        internal abstract class IdentifierUsedAsValueFinder
        {
            ...
            {
                unboundLambda.HasExplicitReturnType(out RefKind refKind, out TypeWithAnnotations returnType, out TypeWithAnnotations returnTypeWithoutUnwrappingAliasTarget);
