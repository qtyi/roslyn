...
public class A
{
            ...
            requestor.VerifyDiagnostics(
                ...
                // error CS0284: Friend access was granted by 'John, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2',
                // but the public key of the granting assembly ('Paul, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null')
                // does not match that specified by the /friendaccessto command-line argument.
                Diagnostic(ErrorCode.ERR_FriendRefNotEqualToOrigin)
                    .WithArguments("John, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2", "Paul, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null")
                    .WithLocation(1, 1)
                );
        }
...
public class A
{
            ...
            requestor.VerifyDiagnostics(
                // error CS0284: Friend access was granted by 'John, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2',
                // but the public key of the granting assembly ('Paul, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2')
                // does not match that specified by the /friendaccessto command-line argument.
                Diagnostic(ErrorCode.ERR_FriendRefNotEqualToOrigin)
                    .WithArguments("John, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2", "Paul, Version=0.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2")
                    .WithLocation(1, 1),
                // (2,12): error CS0122: 'AssemblyKeyNameAttribute' is inaccessible due to its protection level
                // [assembly: AssemblyKeyName()]
                Diagnostic(ErrorCode.ERR_BadAccess, "AssemblyKeyName").WithArguments("AssemblyKeyNameAttribute").WithLocation(2, 12)
