...
namespace Microsoft.CodeAnalysis
{
    ...
    public readonly struct NameWithArity : IComparable<NameWithArity>
    {
        ...
        public static NameWithArity Parse(string str)
        {
            var name = MetadataHelpers.InferTypeArityAndUnmangleMetadataName(str, out var arity);
            return new NameWithArity(name, arity);
        }
