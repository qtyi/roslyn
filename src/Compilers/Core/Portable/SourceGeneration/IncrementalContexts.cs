...
namespace Microsoft.CodeAnalysis
{
    ...
    public readonly partial struct IncrementalGeneratorInitializationContext
    {
        ...
        /// <summary>
        /// Gets an <see cref="IncrementalValueProvider{T}"/> that provides access to the <see cref="SyntaxTree"/> being processed.
        /// The value of this provider changes whenever the syntax trees in the compilation change (e.g., source files are added, removed, or modified).
        /// </summary>
    ...
    public readonly struct SourceProductionContext
    {
        ...
        internal SourceProductionContext(AdditionalSourcesCollection sources, ModifiedTextsCollection modifiedTexts, PooledHashSet<SyntaxTree> excludedSources, DiagnosticBag diagnostics, Compilation compilation, SourceHashAlgorithm checksumAlgorithm, CancellationToken cancellationToken)
        {
            CancellationToken = cancellationToken;
            Sources = sources;
