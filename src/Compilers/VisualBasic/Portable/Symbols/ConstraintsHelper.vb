...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend Module ConstraintsHelper
        ...
        Public Function CheckConstraintsForAlias(
            ...
            Dim diagnosticsBuilder = ArrayBuilder(Of TypeParameterDiagnosticInfo).GetInstance()
            Dim useSiteDiagnosticsBuilder As ArrayBuilder(Of TypeParameterDiagnosticInfo) = Nothing
            Dim result = CheckAliasConstraints([alias], typeArguments, languageVersion, diagnosticsBuilder, useSiteDiagnosticsBuilder, template)
        ...
        Public Function CheckConstraints(
            ...
            If Not RequiresChecking([alias]) Then
                Return True
            End If
            Return CheckAliasConstraints([alias], typeArguments, languageVersion, diagnosticsBuilder, useSiteDiagnosticsBuilder, template)
        End Function
        ...
        Private Function CheckAliasConstraints(
            ...
            Return CheckConstraints([alias]， languageVersion, substitution, [alias].TypeParameters, typeArguments, diagnosticsBuilder, useSiteDiagnosticsBuilder, template)
        End Function
