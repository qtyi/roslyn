...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    ''' <summary>
    ''' An AliasTypeParametersBinder provides the context for looking up type parameters on an generic alias.
    ''' It is split out since binding of type in the parameters and return value need to happen with a context
    ''' that includes the type parameters, but we don't have a fully complete alias symbol yet.
    ''' </summary>
    Friend NotInheritable Class AliasTypeParametersBinder
        Inherits Binder
