        ...
        Public Function ConstructAndValidateConstraints(genericTypeOrAlias As NamedTypeOrAliasSymbol,
            ...
            If checkConstraints AndAlso ShouldCheckConstraints Then
                ...
                If genericTypeOrAlias.IsNamedType Then
                    ...
                    DirectCast(constructedType, NamedTypeSymbol).CheckConstraintsForNonTuple(syntaxArguments, diagnostics, compoundUseSiteInfo)
                Else
                    genericTypeOrAlias.AliasSymbol.CheckConstraintsForAlias(typeArguments, syntaxArguments, diagnostics, compoundUseSiteInfo)
                End If
            End If
